...
def seed_database(db: Session):
    ...
    # 3. Seed Merch
    merch = [
        models.MerchItem(name="Blobby Plush Toy", cat="Collectibles", price=34.99, color="#c084fc", emoji="🧸", image=""),
        models.MerchItem(name="Ferno Graphic Tee", cat="Apparel", price=29.99, color="#f472b6", emoji="👕", image=""),
        models.MerchItem(name="AIROCX Enamel Pin Set", cat="Accessories", price=18.99, color="#fbbf24", emoji="📌", image=""),
        models.MerchItem(name="Crystal Tides Art Print", cat="Art & Posters", price=24.99, color="#67e8f9", emoji="🖼️", image=""),
        models.MerchItem(name="Zolt Inventor Kit", cat="Toys & Games", price=49.99, color="#f59e0b", emoji="🔧", image=""),
        models.MerchItem(name="Aqui Water Bottle", cat="Accessories", price=22.99, color="#06b6d4", emoji="💧", image=""),
        models.MerchItem(name="AIROCX Hoodie", cat="Apparel", price=59.99, color="#a855f7", emoji="🧥", image=""),
        models.MerchItem(name="Character Sticker Pack", cat="Collectibles", price=9.99, color="#ec4899", emoji="✨", image="")
    ]
    db.add_all(merch)
